...
def calculate_wellbore_angles(ax, ay, az, mx, my, mz, declination=0.0):
    """
    ax, ay, az: 加速度计读数 (g)
    mx, my, mz: 磁力计读数 (µT)
    declination: 当地磁偏角（度）
    ...
    return azimuth, inclination, toolface, quaternion


if __name__ == "__main__":
    ax, ay, az = -0.296425683, 0.08020067, 0.9516825
    mx, my, mz = 23.90136719, -10.91308594, 54.1015625
    azimuth, inclination, toolface, quaternion = calculate_wellbore_angles(
        ax, ay, az, mx, my, mz
    )
